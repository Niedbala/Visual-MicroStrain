...
namespace Proba_poboru_danych
{
    public partial class OknoKonfiguracji : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Visualization.node_auto = node_int;
            char chanel_char = chanel[2];
            Int16 chanel_int = Int16.Parse("0" + chanel_char);
            Visualization.chanel_auto = chanel_int;
            this.Hide();
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            else { comboBox6.SelectedItem = "Node" + Visualization.node_auto.ToString() +":ch" + Visualization.chanel_auto.ToString(); }
